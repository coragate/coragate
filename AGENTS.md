...
This repo implements [SPEC-gateway-mvp](https://github.com/coragate/coragate-docs/tree/main/docs/specs/gateway-mvp) and [SPEC-pii-entities](https://github.com/coragate/coragate-docs/tree/main/docs/specs/pii-entities). Architecture source of truth is **coragate-docs**—do not write a conflicting story here.
...
- New behavior needs a spec in the docs repo first. Commits cite `SPEC-gateway-mvp#AC-n` or `SPEC-pii-entities#AC-n`.
